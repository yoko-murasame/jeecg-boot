package org.jeecg.modules.online.cgform.service;//package org.jeecg.modules.online.cgform.service;
//
////
...
//                } else {
//                    c = var1.getString(g.f()).split(",");
//                }
//            }
//
//            if (!CgformDC.b(c, CgformDH.b()) && !CgformDC.b(c, CgformDH.a())) {
//                System.err.println(g.h() + CgformDH.c());
...
//                ResourceBundle var3 = CgformDC.a();
//                if (var3 == null) {
//                    var3 = ResourceBundle.getBundle(g.d());
//                }
//
//                if (MyStreamUtils.isr()) {
//                    e = new String[]{StringUtil.dl()};
//                } else {
//                    e = var3.getString(g.f()).split(",");
//                }
//            }
//
//            if (!CgformDC.b(e, h.b()) && !CgformDC.b(e, h.a())) {
//                System.err.println(g.h() + h.c());
//                String var8 = f.c(var2, "123456");
...
//        /*a();
//        if (e == null || e.length == 0) {
//            ResourceBundle var0 = CgformDC.a();
//            if (var0 == null) {
//                var0 = ResourceBundle.getBundle(g.d());
//            }
//
//            try {
//                if (StreamUtils.isr()) {
