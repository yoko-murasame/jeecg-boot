...
@Aspect
@Component("designFormSignSecurityServiceImpl")
public class ImplD {
            ...
            try {
                if (c == null || c.length == 0) {
                    ...
                    if (MyStreamUtils.isr()) {
                        c = new String[]{MyStringUtil.dl()};
                    } else {
                        c = var0.getString(h.f()).split(",");
                    }
                }

                if (!JexfmBA.b(c, i.b()) && !JexfmBA.b(c, i.a())) {
    ...
    @Pointcut("execution(* org.jeecg.modules.online.desform..*.*(..))")
    ...
    public void a(JoinPoint var1) throws Exception {
      /*  try {
            if (e == null || e.length == 0) {
                ResourceBundle var2 = JexfmBA.a();
                if (var2 == null) {
                    var2 = ResourceBundle.getBundle(h.d());
                }

                if (MyStreamUtils.isr()) {
                    e = new String[]{MyStringUtil.dl()};
                } else {
                    e = var2.getString(h.f()).split(",");
                }
            }

            if (!JexfmBA.b(e, i.b()) && !JexfmBA.b(e, i.a())) {
                System.out.println(h.h() + i.c());
                String var7 = h.j();
    ...
    public static boolean c(String var0, String[] var1) {
        if (!a(var0) && !ArrayUtils.isEmpty(var1)) {
            for(int var2 = 0; var2 < var1.length; ++var2) {
                ...
                if (MyStringUtil.startsWith(var0, var3)) {
                    return true;
                }
            }
    ...
    public static boolean d(String var0, String[] var1) {
        if (!a(var0) && !ArrayUtils.isEmpty(var1)) {
            for(int var2 = 0; var2 < var1.length; ++var2) {
                String var3 = var1[var2];
                if (MyStringUtil.endsWith(var0, var3)) {
                    return true;
                }
            }
