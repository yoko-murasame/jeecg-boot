...
@Data
@TableName("ext_act_process_node_deploy")
public class ExtActProcessNodeDeployment implements Serializable {
    private static final long serialVersionUID = -3314302085698637008L;
    @TableId(
