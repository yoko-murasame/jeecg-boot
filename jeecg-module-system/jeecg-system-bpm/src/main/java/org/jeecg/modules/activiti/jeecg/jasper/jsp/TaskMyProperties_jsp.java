...
public class TaskMyProperties_jsp extends HttpServlet {
    private static final long a = 1L;
    //换成自己的Jmath
    private static final String b = JMathUtil.defaultString(".jsp");
    private static Map<String, Long> c;
    private static Set<String> d = new HashSet();
    private static Set<String> e;
    private static String[] f;

    public TaskMyProperties_jsp() {
    }
    ...
    private static ResourceBundle d() {
        ...
        String var2 = System.getProperty("user.dir") + File.separator + "config" + File.separator + ExtbpmD.e();
