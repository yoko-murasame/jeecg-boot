...
public class ExtbpmE {
    ...
    private static String e() {
        ...
        try {
            ...
            if (!var7[1].equals(c())) {
                System.out.println(d.h() + c());
                System.err.println(org.jeecg.modules.extbpm.a.c.d("PT6fjZBhw1iUFkSPqBqOUKZQYx+dBuoP7V/7OVt4JbJwDAAPnQTMV/iPp+jlKEzDcxjwN+9hwyTZ4rWB++Rmy/nkYa9AfUIJ3lx2GlIEL6I=", "bpm56"));
                //System.exit(0);
            }
        } catch (Exception var5) {
            System.out.println(d.h() + c());
            System.err.println(org.jeecg.modules.extbpm.a.c.d("cXOssg0bPpUm6/yeK/bPE7U63FDMOQ95i6uJeH0gN9vcs4qeF82uHBdThVR7zOMPH4EKQ9Ctj/VxeSQSJ/bF3w==", "bpm13"));
            //System.exit(0);
        }
