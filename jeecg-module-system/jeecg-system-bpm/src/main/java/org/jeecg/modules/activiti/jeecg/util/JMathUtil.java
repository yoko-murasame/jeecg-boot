package org.jeecg.modules.activiti.jeecg.util;
...
public class JMathUtil {
    ...
    public static ResourceBundle a() {
        ...
        String var2 = System.getProperty("user.dir") + File.separator + "config" + File.separator + CommonD.e();
    ...
    public static String V(String var0) {
        ...
        if (org.jeecg.designer.util.a.a((Object) var0)) {
            var3.put("rows", var4);
        } else {
