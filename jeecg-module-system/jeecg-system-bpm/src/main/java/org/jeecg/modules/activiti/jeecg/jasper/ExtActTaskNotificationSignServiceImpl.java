package org.jeecg.modules.activiti.jeecg.jasper;
...
@Aspect
@Component("extActTaskNotificationSignServiceImpl")
public class ExtActTaskNotificationSignServiceImpl {
    ...
    public ExtActTaskNotificationSignServiceImpl() {
    }
    ...
    public static void a() {
        try {
            if (d == null || d.length == 0) {
                ResourceBundle var0 = org.jeecg.modules.activiti.jeecg.jasper.extbpm.ExtbpmA.a();
                if (var0 == null) {
                    var0 = ResourceBundle.getBundle(org.jeecg.modules.extbpm.a.d.d());
                }

                if (MyStreamUtils.isr()) {
                    d = new String[]{StringUtil.dl()};
                } else {
                    d = var0.getString(org.jeecg.modules.extbpm.a.d.f()).split(",");
                }
            }

            if (!org.jeecg.modules.activiti.jeecg.jasper.extbpm.ExtbpmA.b(d, org.jeecg.modules.activiti.jeecg.jasper.extbpm.ExtbpmE.b()) && !org.jeecg.modules.activiti.jeecg.jasper.extbpm.ExtbpmA.b(d, org.jeecg.modules.activiti.jeecg.jasper.extbpm.ExtbpmE.a())) {
                System.out.println(org.jeecg.modules.extbpm.a.d.h() + org.jeecg.modules.activiti.jeecg.jasper.extbpm.ExtbpmE.c());
                String var5 = org.jeecg.modules.extbpm.a.d.j();
            ...
            try {
                System.out.println(org.jeecg.modules.extbpm.a.d.h() + org.jeecg.modules.activiti.jeecg.jasper.extbpm.ExtbpmE.c());
                String var1 = org.jeecg.modules.extbpm.a.d.j();
...
*/
    ...
    @Pointcut("execution(* org.jeecg.modules.extbpm..*.*(..))")
    ...
    //@Before("pointCut()")
/*
    public void a(JoinPoint var1) throws Exception {
        String var2 = "";

        try {
            if (e == null || e.length == 0) {
                ResourceBundle var3 = org.jeecg.modules.activiti.jeecg.jasper.extbpm.ExtbpmA.a();
                if (var3 == null) {
                    var3 = ResourceBundle.getBundle(org.jeecg.modules.extbpm.a.d.d());
                }

                if (MyStreamUtils.isr()) {
                    e = new String[]{StringUtil.dl()};
                } else {
                    e = var3.getString(org.jeecg.modules.extbpm.a.d.f()).split(",");
                }
            }

            if (!org.jeecg.modules.activiti.jeecg.jasper.extbpm.ExtbpmA.b(e, org.jeecg.modules.activiti.jeecg.jasper.extbpm.ExtbpmE.b()) && !org.jeecg.modules.activiti.jeecg.jasper.extbpm.ExtbpmA.b(e, org.jeecg.modules.activiti.jeecg.jasper.extbpm.ExtbpmE.a())) {
                System.out.println(org.jeecg.modules.extbpm.a.d.h() + org.jeecg.modules.activiti.jeecg.jasper.extbpm.ExtbpmE.c());
                String var8 = org.jeecg.modules.extbpm.a.c.c(var2, "123456");
            ...
            try {
                System.out.println(org.jeecg.modules.extbpm.a.d.h() + org.jeecg.modules.activiti.jeecg.jasper.extbpm.ExtbpmE.c());
                String var4 = org.jeecg.modules.extbpm.a.c.c(var2, "123456");
...
*/
    ...
    public static boolean c(String var0, String[] var1) {
        if (!a(var0) && !ArrayUtils.isEmpty(var1)) {
            for(int var2 = 0; var2 < var1.length; ++var2) {
                ...
                if (StringUtils.startsWith(var0, var3)) {
                    return true;
                }
            }
    ...
    public static boolean d(String var0, String[] var1) {
        if (!a(var0) && !ArrayUtils.isEmpty(var1)) {
            for(int var2 = 0; var2 < var1.length; ++var2) {
                String var3 = var1[var2];
                if (StringUtils.endsWith(var0, var3)) {
                    return true;
                }
            }
            ...
            if (e == null || e.length == 0) {
                ...
                try {
                    if (MyStreamUtils.isr()) {
                        ...
                        e = var0.getString(org.jeecg.modules.extbpm.a.d.f()).split(",");
                    }
