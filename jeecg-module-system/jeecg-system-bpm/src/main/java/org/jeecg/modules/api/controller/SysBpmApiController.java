...
public class SysBpmApiController {
     ...
     */
    @PostMapping("/saveManyFormDataByJavaBean")
    String saveManyFormDataByJavaBean(@RequestParam String code, @RequestBody Object javaBean) {
        try {
            return onlCgformHeadService.saveManyFormDataByJavaBean(code, javaBean);
        } catch (Exception e) {
            return "";
        }
    }
     ...
     * @return java.lang.String 数据库表名
     */
    @PostMapping("/editManyFormDataByJavaBean")
    String editManyFormDataByJavaBean(@RequestParam String code, @RequestBody JSONObject javaBean){
        try {
            return onlCgformHeadService.editManyFormDataByJavaBean(code, javaBean);
        } catch (Exception e) {
            return "";
        }
    }
