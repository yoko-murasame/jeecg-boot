...
public class MathUtil {
    ...
    public static boolean a(String var0, List<String> var1) {
        if (var0 != null && var1 != null) {
            for(String var3 : var1) {
                if (var3 != null && var0.indexOf(var3) != -1) {
                    return true;
                }
            }
    ...
    public static void b() {
        ...
        //             e = new String[]{d()};
        //         } else {
        //             e = var1.getString(org.jeecg.designer.commons.a.d.f()).split(",");
        //         }
        //     }
        //
    ...
    public static String B(String var0, String var1) {
        if (!a(var0) && !a(var1)) {
            return U(var0, var1) ? var0.substring(var1.length()) : var0;
        } else {
            return var0;
        }
    }
    ...
    public static String D(String var0, String var1) {
        if (!a(var0) && !a(var1)) {
            return W(var0, var1) ? var0.substring(0, var0.length() - var1.length()) : var0;
        } else {
            return var0;
        }
    }
                ...
                if (var5 != var6) {
                    ...
                    for(int var11 = 0; var11 < var5; ++var11) {
                        if (!var7[var11] && var1[var11] != null && var1[var11].length() != 0 && var2[var11] != null) {
                            var10 = var0.indexOf(var1[var11]);
                            if (var10 == -1) {
                                var7[var11] = true;
                            } else if (var8 == -1 || var10 < var8) {
                                var8 = var10;
                                var9 = var11;
                            }
                        }
                    ...
                    if (var8 == -1) {
                        ...
                        for(int var13 = 0; var13 < var1.length; ++var13) {
                            if (var1[var13] != null && var2[var13] != null) {
                                int var14 = var2[var13].length() - var1[var13].length();
                                if (var14 > 0) {
                                    var12 += 3 * var14;
                                }
                            }
                        ...
                        StrBuilder var21 = new StrBuilder(var0.length() + var12);

                        while(var8 != -1) {
                            for(int var22 = var19; var22 < var8; ++var22) {
                                var21.append(var0.charAt(var22));
                            }

                            var21.append(var2[var9]);
                            var19 = var8 + var1[var9].length();
                            var8 = -1;
                            var9 = -1;
                            var10 = -1;

                            for(int var23 = 0; var23 < var5; ++var23) {
                                if (!var7[var23] && var1[var23] != null && var1[var23].length() != 0 && var2[var23] != null) {
                                    var10 = var0.indexOf(var1[var23], var19);
                                    if (var10 == -1) {
                                        var7[var23] = true;
                                    } else if (var8 == -1 || var10 < var8) {
                                        var8 = var10;
                        ...
                        for(int var15 = var19; var15 < var24; ++var15) {
                            var21.append(var0.charAt(var15));
                        }

                        String var25 = var21.toString();
                        if (!var3) {
                            return var25;
                        } else {
                            return a(var25, var1, var2, var3, var4 - 1);
                        }
                    }
                }
            }
            ...
            if (var1 != 1 && var2 != 0) {
                if (var2 == 1 && var1 <= 8192) {
                    ...
                    switch (var2) {
                        ...
                        default:
                            StrBuilder var13 = new StrBuilder(var3);
    ...
    public static int K(String var0, String var1) {
        if (!a(var0) && !a(var1)) {
            ...
            int var4;
            for(var4 = 0; (var4 = var0.indexOf(var1, var4)) != -1; var4 += var1.length()) {
                ++var2;
            }
    ...
    public static String N(String var0, String var1) {
        if (var0 == null) {
            ...
            ArrayUtils.reverse(var2);
            return var1 == null ? a((Object[])var2, (char)' ') : a((Object[])var2, var1);
        }
    }
    ...
    public static String O(String var0, String var1) {
        if (var0 == null) {
            ...
            int var2 = P(var0, var1);
            return var2 == -1 ? "" : var1.substring(var2);
        }
    }

    public static int P(String var0, String var1) {
        if (var0 == var1) {
            return -1;
    ...
    public static int Q(String var0, String var1) {
        if (var0 != null && var1 != null) {
            ...
            if (var2 == 0) {
                ...
                for(int var7 = 0; var7 <= var2; var11[var7] = var7++) {
                }
                ...
                for(int var8 = 1; var8 <= var3; ++var8) {
                    ...
                    for(int var12 = 1; var12 <= var2; ++var12) {
                        int var10 = var0.charAt(var12 - 1) == var9 ? 0 : 1;
                        var5[var12] = Math.min(Math.min(var5[var12 - 1] + 1, var11[var12] + 1), var11[var12 - 1] + var10);
                    }
    ...
    public static String S(String var0, String var1) {
        return var0 != null && !var0.equals("") ? var0 : var1;
    }
    ...
    public static boolean a(Class<?> var0) {
        ...
        if (var0.isArray()) {
            var1 = false;
        } else if (var0.isPrimitive() || var0.getPackage() == null || var0.getPackage().getName().equals("java.lang") || var0.getPackage().getName().equals("java.math") || var0.getPackage().getName().equals("java.util")) {
            var1 = true;
        }
    ...
    public static String d() {
        ...
        // }
        //
        // JSONObject var12 = org.jeecg.designer.commons.a.b.a(var3, "POST", "body=" + var8, var10);
        // if (var12 != null) {
    ...
    public static String U(String var0) {
        ...
        try {
            InputStream var2 = DesUtils.class.getClassLoader().getResourceAsStream(var0.replace("classpath:", ""));
    ...
    public static String V(String var0) {
        ...
        if (org.jeecg.designer.util.a.a(var0) != null) {
            var3.put("rows", var4);
        } else {
