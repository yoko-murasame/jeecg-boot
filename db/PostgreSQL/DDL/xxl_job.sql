...
values  (1, 'xxl-job-executor-sample', '示例执行器', 0, null);insert into xxl_job_info (id, job_group, job_cron, job_desc, add_time, update_time, author, alarm_email, executor_route_strategy, executor_handler, executor_param, executor_block_strategy, executor_timeout, executor_fail_retry_count, glue_type, glue_source, glue_remark, glue_updatetime, child_jobid, trigger_status, trigger_last_time, trigger_next_time)
values  (1, 1, '0 0 0 * * ? *', '测试任务1', '2018-11-03 22:21:31.000000', '2018-11-03 22:21:31.000000', 'XXL', '', 'FIRST', 'demoJobHandler', '', 'SERIAL_EXECUTION', 0, 0, 'BEAN', '', 'GLUE代码初始化', '2018-11-03 22:21:31.000000', '', 0, 0, 0);insert into xxl_job_lock (lock_name)
values  ('schedule_lock');;;;;insert into xxl_job_user (id, username, password, role, permission)
