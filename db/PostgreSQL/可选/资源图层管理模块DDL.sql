-- 备注：前端模块路径 src/views/business/ResourceLayerList.vue
-- auto-generated definition
create table cb_resource_file
(
    id            bigint not null
...
alter table cb_resource_file
    owner to postgres;

-- auto-generated definition
create table cb_resource_layer
(
    id                    bigint not null
        primary key,
