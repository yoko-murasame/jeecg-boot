...
create_container_cmds=(
  ...
  "docker run -di --network=host -v /home/nginx/nginx.conf:/etc/nginx/nginx.conf -v /home/nginx/log:/usr/log/nginx -v /home/nginx/conf.d:/etc/nginx/conf.d -v /home/nginx/html:/home/nginx/html --name ${container_names[2]} ${image_names[2]}"
)
