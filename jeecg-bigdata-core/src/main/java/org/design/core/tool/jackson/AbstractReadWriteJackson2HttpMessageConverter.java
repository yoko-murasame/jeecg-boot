...
/* loaded from: bigdata-core-tool-3.1.0.jar:org/design/core/tool/jackson/AbstractReadWriteJackson2HttpMessageConverter.class */
public abstract class AbstractReadWriteJackson2HttpMessageConverter extends AbstractJackson2HttpMessageConverter {
    ...
    protected void writeInternal(Object object, @Nullable Type type, HttpOutputMessage outputMessage) throws IOException, HttpMessageNotWritableException {
        ...
        JsonGenerator generator = this.writeObjectMapper.getFactory().createGenerator(outputMessage.getBody(), getJsonEncoding(contentType));
        try {
